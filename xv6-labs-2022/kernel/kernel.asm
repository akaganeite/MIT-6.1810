...
sys_sleep(void)
{
  ...
  while(ticks - ticks0 < n){
    ...
    8000215c:	5d898993          	addi	s3,s3,1496 # 8000e730 <tickslock>
    80002160:	00006497          	auipc	s1,0x6
    80002164:	76848493          	addi	s1,s1,1896 # 800088c8 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    80002198:	59c50513          	addi	a0,a0,1436 # 8000e730 <tickslock>
  ...
  return 0;
    ...
    800021be:	57650513          	addi	a0,a0,1398 # 8000e730 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002206:	52e50513          	addi	a0,a0,1326 # 8000e730 <tickslock>
    8000220a:	00004097          	auipc	ra,0x4
    8000220e:	f22080e7          	jalr	-222(ra) # 8000612c <acquire>
  xticks = ticks;
    80002212:	00006497          	auipc	s1,0x6
    80002216:	6b64a483          	lw	s1,1718(s1) # 800088c8 <ticks>
  release(&tickslock);
    8000221a:	0000c517          	auipc	a0,0xc
    8000221e:	51650513          	addi	a0,a0,1302 # 8000e730 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002256:	4f650513          	addi	a0,a0,1270 # 8000e748 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002266:	4e678793          	addi	a5,a5,1254 # 80016748 <bcache+0x8000>
    8000226a:	00014717          	auipc	a4,0x14
    8000226e:	74670713          	addi	a4,a4,1862 # 800169b0 <bcache+0x8268>
    80002272:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002276:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    8000227a:	0000c497          	auipc	s1,0xc
    8000227e:	4e648493          	addi	s1,s1,1254 # 8000e760 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    800022de:	46e50513          	addi	a0,a0,1134 # 8000e748 <bcache>
    800022e2:	00004097          	auipc	ra,0x4
    800022e6:	e4a080e7          	jalr	-438(ra) # 8000612c <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    800022ea:	00014497          	auipc	s1,0x14
    800022ee:	7164b483          	ld	s1,1814(s1) # 80016a00 <bcache+0x82b8>
    800022f2:	00014797          	auipc	a5,0x14
    800022f6:	6be78793          	addi	a5,a5,1726 # 800169b0 <bcache+0x8268>
    ...
    8000231e:	42e50513          	addi	a0,a0,1070 # 8000e748 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    8000233c:	6c04b483          	ld	s1,1728(s1) # 800169f8 <bcache+0x82b0>
    80002340:	00014797          	auipc	a5,0x14
    80002344:	67078793          	addi	a5,a5,1648 # 800169b0 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    8000237c:	3d050513          	addi	a0,a0,976 # 8000e748 <bcache>
...
brelse(struct buf *b)
{
  ...
  if (b->refcnt == 0) {
    ...
    8000244c:	30078793          	addi	a5,a5,768 # 80016748 <bcache+0x8000>
    80002450:	2b87b703          	ld	a4,696(a5)
    80002454:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002456:	00014717          	auipc	a4,0x14
    8000245a:	55a70713          	addi	a4,a4,1370 # 800169b0 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    8000246e:	2de50513          	addi	a0,a0,734 # 8000e748 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024a6:	2a650513          	addi	a0,a0,678 # 8000e748 <bcache>
  ...
  release(&bcache.lock);
    ...
    800024bc:	29050513          	addi	a0,a0,656 # 8000e748 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024e2:	26a50513          	addi	a0,a0,618 # 8000e748 <bcache>
  ...
  release(&bcache.lock);
    ...
    800024f8:	25450513          	addi	a0,a0,596 # 8000e748 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80002524:	9047a783          	lw	a5,-1788(a5) # 80016e24 <sb+0x1c>
...
000000008000258a <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    800025a8:	8687a783          	lw	a5,-1944(a5) # 80016e0c <sb+0x4>
...
00000000800027aa <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    800027c2:	66a50513          	addi	a0,a0,1642 # 80016e28 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    800027d4:	67048493          	addi	s1,s1,1648 # 80016e40 <itable+0x18>
    800027d8:	00016697          	auipc	a3,0x16
    800027dc:	0f868693          	addi	a3,a3,248 # 800188d0 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002808:	62450513          	addi	a0,a0,1572 # 80016e28 <itable>
  ...
  release(&itable.lock);
    ...
    80002838:	5f450513          	addi	a0,a0,1524 # 80016e28 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    80002886:	58698993          	addi	s3,s3,1414 # 80016e08 <sb>
  ...
  initlog(dev, &sb);
    ...
    800028ba:	55258593          	addi	a1,a1,1362 # 80016e08 <sb>
...
00000000800028e6 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002900:	52c50513          	addi	a0,a0,1324 # 80016e28 <itable>
    80002904:	00003097          	auipc	ra,0x3
    80002908:	798080e7          	jalr	1944(ra) # 8000609c <initlock>
  for(i = 0; i < NINODE; i++) {
    8000290c:	00014497          	auipc	s1,0x14
    80002910:	54448493          	addi	s1,s1,1348 # 80016e50 <itable+0x28>
    80002914:	00016997          	auipc	s3,0x16
    80002918:	fcc98993          	addi	s3,s3,-52 # 800188e0 <log+0x10>
...
0000000080002946 <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    80002960:	4b872703          	lw	a4,1208(a4) # 80016e14 <sb+0xc>
    ...
    80002974:	498a0a13          	addi	s4,s4,1176 # 80016e08 <sb>
...
0000000080002a18 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002a30:	3f45a583          	lw	a1,1012(a1) # 80016e20 <sb+0x18>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    800032d2:	60290913          	addi	s2,s2,1538 # 800188d0 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800032f6:	60e78793          	addi	a5,a5,1550 # 80018900 <log+0x30>
    ...
    8000330a:	5fe60613          	addi	a2,a2,1534 # 80018904 <log+0x34>
...
000000008000333c <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003340:	5c07a783          	lw	a5,1472(a5) # 800188fc <log+0x2c>
    80003344:	0af05d63          	blez	a5,800033fe <install_trans+0xc2>
{
    ...
    80003362:	5a2a8a93          	addi	s5,s5,1442 # 80018900 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003366:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003368:	00015997          	auipc	s3,0x15
    8000336c:	56898993          	addi	s3,s3,1384 # 800188d0 <log>
...
0000000080003400 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003416:	4be48493          	addi	s1,s1,1214 # 800188d0 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003456:	4ae68693          	addi	a3,a3,1198 # 80018900 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    8000348a:	4607ab23          	sw	zero,1142(a5) # 800188fc <log+0x2c>
...
begin_op(void)
{
  ...
  while(1){
    ...
    8000350a:	3ca50513          	addi	a0,a0,970 # 800188d0 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000353a:	39a48493          	addi	s1,s1,922 # 800188d0 <log>
  ...
  if(log.outstanding == 0){
    ...
    8000355e:	37648493          	addi	s1,s1,886 # 800188d0 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    8000357a:	35a48493          	addi	s1,s1,858 # 800188d0 <log>
    ...
    800035c6:	30e48493          	addi	s1,s1,782 # 800188d0 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800035e4:	320a8a93          	addi	s5,s5,800 # 80018900 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    800035e8:	00015a17          	auipc	s4,0x15
    800035ec:	2e8a0a13          	addi	s4,s4,744 # 800188d0 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    8000366e:	2807a923          	sw	zero,658(a5) # 800188fc <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    8000368e:	24690913          	addi	s2,s2,582 # 800188d0 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800036cc:	23870713          	addi	a4,a4,568 # 80018900 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    800036e8:	1ec78793          	addi	a5,a5,492 # 800188d0 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003738:	19c70713          	addi	a4,a4,412 # 800188d0 <log>
  ...
  release(&log.lock);
    ...
    8000374a:	18a50513          	addi	a0,a0,394 # 800188d0 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800038a0:	17c50513          	addi	a0,a0,380 # 80018a18 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800038c2:	15a50513          	addi	a0,a0,346 # 80018a18 <ftable>
    800038c6:	00003097          	auipc	ra,0x3
    800038ca:	866080e7          	jalr	-1946(ra) # 8000612c <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    800038ce:	00015497          	auipc	s1,0x15
    800038d2:	16248493          	addi	s1,s1,354 # 80018a30 <ftable+0x18>
    800038d6:	00016717          	auipc	a4,0x16
    800038da:	0fa70713          	addi	a4,a4,250 # 800199d0 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    800038ee:	12e50513          	addi	a0,a0,302 # 80018a18 <ftable>
  ...
  return 0;
    ...
    80003906:	11650513          	addi	a0,a0,278 # 80018a18 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000392e:	0ee50513          	addi	a0,a0,238 # 80018a18 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003948:	0d450513          	addi	a0,a0,212 # 80018a18 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003988:	09450513          	addi	a0,a0,148 # 80018a18 <ftable>
  ...
  release(&ftable.lock);
    ...
    800039c2:	05a50513          	addi	a0,a0,90 # 80018a18 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003b3e:	e3e70713          	addi	a4,a4,-450 # 80018978 <devsw>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003bde:	d9e70713          	addi	a4,a4,-610 # 80018978 <devsw>
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    8000440e:	0d050793          	addi	a5,a0,208 # fffffffffffff0d0 <end+0xffffffff7ffdd380>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80005118:	8bc78793          	addi	a5,a5,-1860 # 800199d0 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    8000512c:	8a878793          	addi	a5,a5,-1880 # 800199d0 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80005154:	89850513          	addi	a0,a0,-1896 # 800199e8 <disk+0x18>
...
0000000080005188 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    800051a0:	95c50513          	addi	a0,a0,-1700 # 80019af8 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80005204:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdca0f>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    8000524e:	78648493          	addi	s1,s1,1926 # 800199d0 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80005272:	76a73703          	ld	a4,1898(a4) # 800199d8 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    8000528a:	74a48493          	addi	s1,s1,1866 # 800199d0 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800053aa:	75250513          	addi	a0,a0,1874 # 80019af8 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800053be:	616b0b13          	addi	s6,s6,1558 # 800199d0 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    800053ca:	732c0c13          	addi	s8,s8,1842 # 80019af8 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800053ec:	5e868693          	addi	a3,a3,1512 # 800199d0 <disk>
  ...
  if(write)
    ...
    8000545e:	57678793          	addi	a5,a5,1398 # 800199d0 <disk>
  ...
  buf0->reserved = 0;
    ...
    8000546c:	56858593          	addi	a1,a1,1384 # 800199d0 <disk>
  ...
  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    ...
    800054d4:	50068693          	addi	a3,a3,1280 # 800199d0 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80005546:	5b698993          	addi	s3,s3,1462 # 80019af8 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    80005570:	46478793          	addi	a5,a5,1124 # 800199d0 <disk>
    80005574:	97ba                	add	a5,a5,a4
    80005576:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    8000557a:	00014997          	auipc	s3,0x14
    8000557e:	45698993          	addi	s3,s3,1110 # 800199d0 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    800055a6:	55650513          	addi	a0,a0,1366 # 80019af8 <disk+0x128>
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    ...
    800055e4:	3f850513          	addi	a0,a0,1016 # 800199d8 <disk+0x8>
  ...
  if(write)
    ...
    800055fa:	3da78793          	addi	a5,a5,986 # 800199d0 <disk>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005614:	3c048493          	addi	s1,s1,960 # 800199d0 <disk>
    80005618:	00014517          	auipc	a0,0x14
    8000561c:	4e050513          	addi	a0,a0,1248 # 80019af8 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005694:	46850513          	addi	a0,a0,1128 # 80019af8 <disk+0x128>
...
timerinit()
{
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
  ...
  uint64 *scratch = &timer_scratch[id][0];
    ...
    800056f4:	42070713          	addi	a4,a4,1056 # 80019b10 <timer_scratch>
...
000000008000572c <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    8000573a:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdcaaf>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    8000582e:	42650513          	addi	a0,a0,1062 # 80021c50 <cons>
  ...
  while(n > 0){
    ...
    8000583e:	41648493          	addi	s1,s1,1046 # 80021c50 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
    ...
    80005848:	4a490913          	addi	s2,s2,1188 # 80021ce8 <cons+0x98>
    }
  ...
  release(&cons.lock);
    ...
    800058cc:	38850513          	addi	a0,a0,904 # 80021c50 <cons>
  ...
  return target - n;
    ...
    800058e2:	37250513          	addi	a0,a0,882 # 80021c50 <cons>
    ...
    8000591a:	3cf72923          	sw	a5,978(a4) # 80021ce8 <cons+0x98>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    80005974:	2e050513          	addi	a0,a0,736 # 80021c50 <cons>
  ...
  release(&cons.lock);
    ...
    800059a2:	2b250513          	addi	a0,a0,690 # 80021c50 <cons>
  ...
  switch(c){
    ...
    800059c6:	28e70713          	addi	a4,a4,654 # 80021c50 <cons>
    ...
    800059f0:	26478793          	addi	a5,a5,612 # 80021c50 <cons>
    ...
    80005a1e:	2ce7a783          	lw	a5,718(a5) # 80021ce8 <cons+0x98>
    ...
    80005a7e:	1d670713          	addi	a4,a4,470 # 80021c50 <cons>
    ...
    80005a94:	26f72023          	sw	a5,608(a4) # 80021cf0 <cons+0xa0>
      consputc(BACKSPACE);
    ...
    80005aba:	19a78793          	addi	a5,a5,410 # 80021c50 <cons>
    ...
    80005ade:	20c7a923          	sw	a2,530(a5) # 80021cec <cons+0x9c>
        wakeup(&cons.r);
    80005ae2:	0001c517          	auipc	a0,0x1c
    80005ae6:	20650513          	addi	a0,a0,518 # 80021ce8 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80005b08:	14c50513          	addi	a0,a0,332 # 80021c50 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    80005b20:	e5c78793          	addi	a5,a5,-420 # 80018978 <devsw>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    ...
    80005bf2:	1207a123          	sw	zero,290(a5) # 80021d10 <pr+0x18>
  printf("panic: ");
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    80005c26:	caf72523          	sw	a5,-854(a4) # 800088cc <panicked>
  for(;;)
...
0000000080005c2c <printf>:
{
  ...
  locking = pr.locking;
    ...
    80005c62:	0b2dad83          	lw	s11,178(s11) # 80021d10 <pr+0x18>
  if(locking)
  ...
  consputc('x');
    ...
    80005ca0:	05c50513          	addi	a0,a0,92 # 80021cf8 <pr>
  ...
  if(locking)
    ...
    80005e04:	ef850513          	addi	a0,a0,-264 # 80021cf8 <pr>
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    80005e20:	edc48493          	addi	s1,s1,-292 # 80021cf8 <pr>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    80005e80:	e9c50513          	addi	a0,a0,-356 # 80021d18 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    ...
    80005eac:	a247a783          	lw	a5,-1500(a5) # 800088cc <panicked>
    for(;;)
      ;
  }
...
uartstart()
{
  while(1){
    ...
    80005ee8:	9ec73703          	ld	a4,-1556(a4) # 800088d0 <uart_tx_r>
    80005eec:	00003797          	auipc	a5,0x3
    80005ef0:	9ec7b783          	ld	a5,-1556(a5) # 800088d8 <uart_tx_w>
    80005ef4:	06e78c63          	beq	a5,a4,80005f6c <uartstart+0x88>
{
    ...
    80005f12:	e0aa0a13          	addi	s4,s4,-502 # 80021d18 <uart_tx_lock>
    uart_tx_r += 1;
    80005f16:	00003497          	auipc	s1,0x3
    80005f1a:	9ba48493          	addi	s1,s1,-1606 # 800088d0 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80005f1e:	00003997          	auipc	s3,0x3
    80005f22:	9ba98993          	addi	s3,s3,-1606 # 800088d8 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
...
0000000080005f6e <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    80005f84:	d9850513          	addi	a0,a0,-616 # 80021d18 <uart_tx_lock>
    80005f88:	00000097          	auipc	ra,0x0
    80005f8c:	1a4080e7          	jalr	420(ra) # 8000612c <acquire>
  if(panicked){
    80005f90:	00003797          	auipc	a5,0x3
    80005f94:	93c7a783          	lw	a5,-1732(a5) # 800088cc <panicked>
    80005f98:	e7c9                	bnez	a5,80006022 <uartputc+0xb4>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80005f9a:	00003797          	auipc	a5,0x3
    80005f9e:	93e7b783          	ld	a5,-1730(a5) # 800088d8 <uart_tx_w>
    80005fa2:	00003717          	auipc	a4,0x3
    80005fa6:	92e73703          	ld	a4,-1746(a4) # 800088d0 <uart_tx_r>
    80005faa:	02070713          	addi	a4,a4,32
    sleep(&uart_tx_r, &uart_tx_lock);
    80005fae:	0001ca17          	auipc	s4,0x1c
    80005fb2:	d6aa0a13          	addi	s4,s4,-662 # 80021d18 <uart_tx_lock>
    80005fb6:	00003497          	auipc	s1,0x3
    80005fba:	91a48493          	addi	s1,s1,-1766 # 800088d0 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80005fbe:	00003917          	auipc	s2,0x3
    80005fc2:	91a90913          	addi	s2,s2,-1766 # 800088d8 <uart_tx_w>
  ...
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    ...
    80005fe8:	d3448493          	addi	s1,s1,-716 # 80021d18 <uart_tx_lock>
  ...
  uart_tx_w += 1;
    ...
    80005ffc:	8ef73023          	sd	a5,-1824(a4) # 800088d8 <uart_tx_w>
  uartstart();
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    80006072:	caa48493          	addi	s1,s1,-854 # 80021d18 <uart_tx_lock>
